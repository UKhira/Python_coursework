...
# check credit(pass,defer,fail) and verify entered value is an integer
    ...
    #Histogram starts here
            ...
            while iter_1 < len(l_progress):          
                print("\nProgress - ", end = ' ')
                for count_list in (l_progress[iter_1:iter_1+2]) :
            ...
            while iter_2 < len(l_module):
                print("\nModule trailer - ", end =' ')
                for count_list in (l_module[iter_2:iter_2+2]) :
                    print(count_list, end=', ')
                else:
                    print(count_list, end=' ')
                iter_2 = iter_2 + 3
            ...
            while iter_3 < len(l_retriever):
                ...
                for count_list in (l_retriever[iter_3:iter_3+2]) :
                    print(count_list, end=', ')
                else:
                    print(count_list, end=' ')
                iter_3 = iter_3 + 3
            ...
            while iter_4 < len(l_excluded):
                print("\nExclude - ", end = ' ')
                for count_list in (l_excluded[iter_4:iter_4+2]) :
                    print(count_list, end=', ')
                else:
                    print(count_list, end=' ')
                iter_4 = iter_4 + 3
